...
class CreateComputeInstanceNetworkInterfaceIPv6sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('compute_instance_network_interface_ipv6s', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('compute_instance_network_interface_ipv6s');
    }
}
